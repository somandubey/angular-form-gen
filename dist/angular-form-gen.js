...
fg.controller('fgEditPaletteController', ["$scope", "fgConfig", "$modal", function ($scope, fgConfig,$modal) {
  ...
  var _loadGroups = function () {
    ...
    $scope.createFormField = function(field, groupId) {
      var _fields = [{
        "type": field.type,
